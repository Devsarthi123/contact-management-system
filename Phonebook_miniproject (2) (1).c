/*
Author : Devsarthi Rawat(RA2111009010146);
    Project Name : Phonebook
    Date created : 26/01/2022
    Description : The phonebook can save contacts and do the following operations.
        1) view all contacts.
        2) add a contact.
        3) remove a contact.
...
void start()
{
    ...
    while(1)
    {
        ...
        switch(choice)
        {
            ...
            default :
                system("cls");
                printf("Thanks for using our phonebook : )\n");
                getchar();
                getchar();
                exit(1);
        }
...
void update_person()
{
    ...
    system("cls");
    long int phone;
    printf("Enter Phone number of the person whose details you want to update : ");
    scanf("%ld",&phone);
